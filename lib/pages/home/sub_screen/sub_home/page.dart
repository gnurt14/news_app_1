...
// Tải thư viện feature1 với deferred
import 'package:news_app/feature1.dart' deferred as feature1;
...
class HomeSubScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<HomeController>(
      ...
      //               onPressed: () {
      //                 // Get.to(
      //                 //   () => MoreNews(label: 'Tin moi', isBreakingNews: true),
      //                 // );
      //               },
      //               child: const Text(
      //                 'Xem thêm',
      ...
      builder: (controller) {
        return Column(
          children: [
            ElevatedButton(
              onPressed: () async {
                // Gọi loadLibrary để tải feature1
                await feature1.loadLibrary();
                // feature1
                //     .someFunction(); // Sử dụng các hàm hoặc widget từ feature1
              },
              child: Text('load component'),
            ),
          ],
        );
      },
